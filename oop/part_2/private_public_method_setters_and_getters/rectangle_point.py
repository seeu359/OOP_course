...
(x2, y2) - правый нижний. При этом, в объектах класса Rectangle
(вне зависимости от способа их создания) должны формироваться следующие
локальные свойства:
...
class Rectangle:
    ...
    def __init__(self, *args):
        self.__args = args
        if self.__check_on_type_point():
            self.__sp: Point = self.__args[0]
